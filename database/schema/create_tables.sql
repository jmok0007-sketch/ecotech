-- EcoTech PostgreSQL — initial schema.
-- Run once on a fresh database:
--   psql "$DATABASE_URL" -f create_tables.sql
--
-- Tables:
--   health_merged          — cancer + mortality (merged from AIHW / ACIM)
--   heavy_metal_state      — Pb / Hg / Cd emissions aggregated by state
--   heavy_metal_facility   — emissions per facility (with lat/lng)
--   ewaste_facilities      — verified e-waste drop-off locations
